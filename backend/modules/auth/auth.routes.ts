...
import { register, login, getMe, getMyEnrollments, getDashboard, refresh, logout, forgotPassword, resetPassword, updateProfile, changePassword, verifyEmail, updateAvatar } from './auth.controller';
...
router.patch('/me/avatar', uploadEngine.single('avatar'), updateAvatar);
