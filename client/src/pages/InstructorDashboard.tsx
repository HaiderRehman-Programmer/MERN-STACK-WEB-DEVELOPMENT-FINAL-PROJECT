...
import { Plus, Settings, Trash2, Globe, Lock, Edit2, DollarSign, Users, TrendingUp, Star, BarChart3, LineChart as LineIcon } from 'lucide-react';
import { 
  ResponsiveContainer, 
  LineChart, 
  Line, 
  ...
  return (
    <div className="container">
            ...
            <CourseCard 
              ...
              footerContent={
                <div style={{ display: 'flex', gap: '0.4rem' }}>
                  ...
                  <Link to={`/instructor/courses/${course.id}/lessons`} className="btn-sm btn-manage" style={{ textDecoration: 'none' }}>
      ...
      <style>{`
        ...
        .chart-title { font-size: 0.9rem; font-weight: 700; margin-bottom: 1.5rem; display: flex; alignItems: center; gap: 0.5rem; color: var(--text-muted); }
