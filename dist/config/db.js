...
const sqlite = new better_sqlite3_2.default(env_1.env.DATABASE_URL);
exports.db = (0, better_sqlite3_1.drizzle)(sqlite, { schema });
const connectDB = async () => {
    try {
        // SQLite connection is synchronous, so we just perform a quick check
        sqlite.pragma('journal_mode = WAL');
        logger_1.logger.info('🗄️ Database connected (SQLite)');
    }
    catch (error) {
