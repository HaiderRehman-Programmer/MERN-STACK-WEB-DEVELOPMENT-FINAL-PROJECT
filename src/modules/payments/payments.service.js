            ...
            if (courseId && studentId) {
                try {
                    ...
                    if (existing.length === 0) {
                        ...
                        logger_1.logger.info({ studentId, courseId }, '✅ Enrollment confirmed via Stripe Webhook');
                    }
                    else {
                        logger_1.logger.warn({ studentId, courseId }, 'ℹ️ Enrollment already exists, skipping webhook insert');
                    }
                }
                catch (dbErr) {
